...
import pandas as pd
################################################################################
## Form generated from reading UI file 'investment_add.ui'
##
...
class Ui_Form(object):
    def add_investment_to_db(self):
        ...
        vet_query_str = """INSERT INTO investments (paper_pk, customer_pk, kotirovka, buy_date, sell_date) 
                VALUES (:paper_pk, :customer_pk, :kotirovka, :buy_date, :sell_date)"""
    ...
    def setupUi(self, Form):
        ...
        self.confirmPushButton = QPushButton(Form, clicked = lambda:self.add_investment_to_db())
    ...
    def retranslateUi(self, Form):
        ...
        self.kotirovkaLineEdit.setText("")
        ...
        self.label_6.setText(QCoreApplication.translate("Form", u"\u0421\u043e\u0437\u0434\u0430\u043d\u0438\u0435 \u0438\u043d\u0432\u0435\u0441\u0442\u0438\u0446\u0438\u0438", None))
    # retranslateUi
